...
public class RestResponseExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception ex) {
        ...
        return new ResponseEntity<>(new ErrorResponse(TestServiceErrorCode.UNEXPECTED_ERROR.getCode(), ex.getMessage()), TestServiceErrorCode.UNEXPECTED_ERROR.getHttpStatus());
    }
}
